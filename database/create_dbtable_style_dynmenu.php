...
// Create table
mysql_query("CREATE TABLE style_dynmenu
(
...
if(tableExists("style_dynmenu",$dbusername,$dbpassword,$dbname))
{
 echo "Created Dynmenu Style Table!";
}
else
{
 echo "Failed to create Dynmenu Style table!";
}
