...
background:<?=$bbgc;?> url('admin/images/bbgimage.<?=$bbgimage;?>') <?=$bbgr;?> <?=$bbga;?> <?=$bbgp;?>;
/*BACKGROUND END*/
height:<?=$bh;?>;
display:<?=$bdisp;?>;
}
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$fullbgc;?> url('admin/images/fullbgimage.<?=$fullbgimage;?>') <?=$fullbgr;?> <?=$fullbga;?> <?=$fullbgp;?>;
/*--Text--*/
color:<?=$fullc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$hfullbgc;?> url('admin/images/hfullbgimage.<?=$hfullbgimage;?>') <?=$hfullbgr;?> <?=$hfullbga;?> <?=$hfullbgp;?>;
/*--Text--*/
color:<?=$hfullc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$hflbgc;?> url('admin/images/hflbgimage.<?=$hflbgimage;?>') <?=$hflbgr;?> <?=$hflbga;?> <?=$hflbgp;?>;
/*--Text--*/
color:<?=$hflc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$bfullbgc;?> url('admin/images/bfullbgimage.<?=$bfullbgimage;?>') <?=$bfullbgr;?> <?=$bfullbga;?> <?=$bfullbgp;?>;
/*--Text--*/
color:<?=$bfullc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$bflbgc;?> url('admin/images/bflbgimage.<?=$bflbgimage;?>') <?=$bflbgr;?> <?=$bflbga;?> <?=$bflbgp;?>;
/*--Text--*/
color:<?=$bflc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$nbgc;?> url('admin/images/nbgimage.<?=$nbgimage;?>') <?=$nbgr;?> <?=$nbga;?> <?=$nbgp;?>;
/*--Text--*/
color:<?=$nc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$pbgc;?> url('admin/images/pbgimage.<?=$pbgimage;?>') <?=$pbgr;?> <?=$pbga;?> <?=$pbgp;?>;
/*--Text--*/
color:<?=$pc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$nrbgc;?> url('admin/images/nrbgimage.<?=$nrbgimage;?>') <?=$nrbgr;?> <?=$nrbga;?> <?=$nrbgp;?>;
/*--Text--*/
color:<?=$nrc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$ffullbgc;?> url('admin/images/ffullbgimage.<?=$ffullbgimage;?>') <?=$ffullbgr;?> <?=$ffullbga;?> <?=$ffullbgp;?>;
/*--Text--*/
color:<?=$ffullc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$fflbgc;?> url('admin/images/fflbgimage.<?=$fflbgimage;?>') <?=$fflbgr;?> <?=$fflbga;?> <?=$fflbgp;?>;
/*--Text--*/
color:<?=$fflc;?>;
...
/*background repeat options: no-repeat, repeat, repeat-x, repeat-y*/
/*background attachment options: scroll(default), fixed, inherit*/
background:<?=$lbgc;?> url('admin/images/lbgimage.<?=$lbgimage;?>') <?=$lbgr;?> <?=$lbga;?> <?=$lbgp;?>;
/*--Text--*/
color:<?=$lc;?>;
