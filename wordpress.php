...
{
 echo "attachment_id is set<br />";
}
*/


 if (!empty($author)) //Display authors
 {
...
<?php
 ...
 elseif (!empty($cat)) //Display categories
 {
?>
	<section id="primary" class="site-content">
		<div id="content" role="main">
...
<?php
 ...
 elseif (!empty($s)) //Display search results
 {
?>
...
<?php
 ...
 elseif (!empty($m)) //Display Archives
 {
?>
	<section id="primary" class="site-content">
		<div id="content" role="main">
...
<?php
 ...
 elseif (!empty($attachment_id)) //Display Attachments (e.g. image, audio, video)
 {
?>
...
<?php
 ...
 elseif (!empty($page_id)) //Display Page with comments
 {
?>
