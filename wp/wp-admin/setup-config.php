...
<form method="post" action="setup-config.php?step=2">
	<p><?php _e( "This form should be pre-filled with the same information you submitted previously. Please click on the Submit button." ); ?></p>
	<table class="form-table">
		...
		<tr>
			...
			<td><input name="uname" id="uname" type="text" size="25" value="<?=$dbusername;?>" /></td>
			<td><?php _e( 'Your MySQL username' ); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="pwd"><?php _e( 'Password' ); ?></label></th>
			<td><input name="pwd" id="pwd" type="text" size="25" value="<?=$dbpassword;?>" /></td>
			<td><?php _e( '&hellip;and your MySQL password.' ); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="dbhost"><?php _e( 'Database Host' ); ?></label></th>
			<td><input name="dbhost" id="dbhost" type="text" size="25" value="<?=$dbhostname;?>" /></td>
